...
public class RemoteServiceDispatcherWithHibernateFilter extends
		RemoteServiceDispatcher {
	/**
	 * 
	 */
	private static final long serialVersionUID = -167852226521643021L;
	 ...
	 */
	public String invokeAndEncodeResponse(Object target, Method serviceMethod,
			Object[] args, SerializationPolicy serializationPolicy)
			throws SerializationException {
	...
	public static String invokeAndEncodeResponse(Object target,
		...
		try {
			...
			responsePayload = RPC.encodeResponseForSuccess(serviceMethod,
					result, serializationPolicy, flags);
			...
			responsePayload = RPC.encodeResponseForFailure(serviceMethod,
					cause, serializationPolicy, flags);
		}
