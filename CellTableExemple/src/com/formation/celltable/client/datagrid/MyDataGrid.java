...
public class MyDataGrid extends Composite {
	...
	@UiField
	DataGrid<MarqueVoiture> tableMarqueVoiture;
	...
	private void initCellTable() {
		...
		tableMarqueVoiture.setColumnWidth(nom, "170px");
		...
		anneeCreation.setCellStyleNames("aGauche");
		tableMarqueVoiture.addColumn(anneeCreation, "Année");
		
		// on change style de l'intitulé de la colonne
